    ...
    return(
        click ? <RunApp36 /> :
                <div onPointerDown={handleClick} 
                    style={{position:'absolute', width:'100vw', height:'100vh', color:'white', background:'url("assets/img/readme/app36_resize.png") no-repeat center center fixed', backgroundSize:'cover', textAlign:'center', display:'flex', alignItems:'center', justifyContent:'center'}}> <h1 style={{fontSize:'4rem'}}>Click On Screen To Start</h1> </div>
    );
}