...
export default function Provider({ children, step, gravity, tolerance, iterations, allowSleep, broadphase, axisIndex, defaultContactMaterial, size, }: ProviderProps): JSX.Element;
